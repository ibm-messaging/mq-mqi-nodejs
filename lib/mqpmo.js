...
function createDefaultPMOBuf() {
  ...
  if (o.offset != pmo.length) {
      console.log("Bad length for MQPMO - check initial structure fields");
      console.log("Offsets map = %o Final offset=%d. Should be %d.", pmoOffsets, o.offset, MQC.MQPMO_LENGTH_3);
  }
  else {
     // console.log("PMO Offsets map = %o\n, Final offset=%d. Should be %d.", pmoOffsets, o.offset, MQC.MQPMO_LENGTH_3);
  }
  return pmo;
}
