...
var _MQCSPffi_t = StructType({
  ...
  // Fields added in MQ 9.3.0
  Reserved3         : MQT.BYTE8 ,
  InitialKeyPtr     : MQT.PTR   ,
  InitialKeyOffset  : MQT.LONG  ,
  InitialKeyLength  : MQT.LONG
});
...
exports._newMQCSPffi = function() {
  ...
  csp.InitialKeyPtr     = ref.NULL_POINTER;
  csp.InitialKeyOffset  = 0;
  csp.InitialKeyLength  = 0;
