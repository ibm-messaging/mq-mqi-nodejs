 ...
 * function.
 *
 * <p>Unimplemented MQI verbs include MQSET, MQBEGIN, and all of the
 ...
 * @param {number}
 *        jsIntAttrs - an array that will contain the returned integer values. The
 *        array may be resized and its contents updated during this call.
 * @param {Buffer}
 *        jsCharAttrBuffer - a Buffer of sufficient size to hold returned string attribute
 *        values.
 * @param {function}
