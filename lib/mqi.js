 ...
 *        message handle
 * @param {MQSMPO}
 *        Options for how the property is set
 * @param {String}
 ...
 *        message handle
 * @param {MQIMPO}
 *        Options for how the property is to be queried
 * @param {MQPD}
 *        property descriptor
 * @param {String}
 *        name - the property name
 ...
 *        message handle
 * @param {MQDMPO}
 *        Options for how the property is to be deleted
 * @param {String}
 *        name - the property name
 * @param {function}
 *        callback - Called when the operation completes.
