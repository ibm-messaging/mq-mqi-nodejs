...
exports.MQCD  = function () {
  ...
  // Quantum-safe options were added to V13 of the MQCD in MQ 10.0
  /** @member {number} */
  this.QuantumSafeAlgorithm = MQC.MQQS_UNPROTECTED;
  /** @member {number} */
  this.QuantumSafeRequired   = MQC.MQQSR_OPTIONAL;
  Object.seal(this);
};
