...
exports.MQCD  = function() {
  ...
  /** @member {Array} */
  this.MsgCompList          = [MQC.MQCOMPRESS_NONE,MQC.MQCOMPRESS_NOT_AVAILABLE, MQC.MQCOMPRESS_NOT_AVALABLE, MQC.MQCOMPRESS_NOT_AVALABLE,
                               MQC.MQCOMPRESS_NOT_AVAILABLE,MQC.MQCOMPRESS_NOT_AVAILABLE, MQC.MQCOMPRESS_NOT_AVALABLE, MQC.MQCOMPRESS_NOT_AVALABLE,
                               MQC.MQCOMPRESS_NOT_AVAILABLE,MQC.MQCOMPRESS_NOT_AVAILABLE, MQC.MQCOMPRESS_NOT_AVALABLE, MQC.MQCOMPRESS_NOT_AVALABLE,
                               MQC.MQCOMPRESS_NOT_AVAILABLE,MQC.MQCOMPRESS_NOT_AVAILABLE, MQC.MQCOMPRESS_NOT_AVALABLE, MQC.MQCOMPRESS_NOT_AVALABLE];
  Object.seal(this);
};
...
exports._newMQCDffi = function() {
  ...
  cd.ConnectionAffinity       = MQC.MQCAFTY_PREFERRED;
...
exports._copyCDtoC = function(jscd) {
  ...
  for (i = 0; i < 2; i++) {
      mqcd.HdrCompList[i] = jscd.HdrCompList[i];
  }
  for (i = 0; i < 16; i++) {
     mqcd.MsgCompList[i] = jscd.HdrCompList[i];
  }
