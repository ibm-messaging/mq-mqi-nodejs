...
exports._copyMDtoC = function(jsmd) {
  ...
  var i;
  mqmd.Report   = u.flagsToNumber('MQRO',jsmd.Report);
  ...
  mqmd.MsgFlags     = u.flagsToNumber('MQMF',jsmd.MsgFlags);
...
exports._copyMDfromC = function(mqmd, jsmd) {
  var i;
  jsmd.Report      = u.flagsFromNumber('MQRO',jsmd.Report,mqmd.Report);
  ...
  jsmd.MsgFlags        = u.flagsFromNumber('MQMF',jsmd.MsgFlags,mqmd.MsgFlags);
