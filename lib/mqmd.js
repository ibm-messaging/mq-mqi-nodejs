...
exports._copyMDtoC = function(jsmd) {
  ...
  for (var i = 0; i < MQC.MQ_MSG_ID_LENGTH; i++) {
    mqmd.MsgId[i] = jsmd.MsgId[i];
  }
  for (var i = 0; i < MQC.MQ_CORREL_ID_LENGTH; i++) {
  ...
  for (var i = 0; i < MQC.MQ_ACCOUNTING_TOKEN_LENGTH; i++) {
  ...
  for (var i = 0; i < MQC.MQ_GROUP_ID_LENGTH; i++) {
