...
exports._copyIMPOtoC = function(jsimpo) {
  ...
  mqimpo.Options = u.flagsToNumber('MQIMPO',jsimpo.Options);
  return mqimpo;
};

exports._copySMPOtoC = function(jssmpo) {
  var mqsmpo = exports._newMQSMPOffi();
  mqsmpo.Options = u.flagsToNumber('MQSMPO',jssmpo.Options);
  return mqsmpo;
};

exports._copyDMPOtoC = function(jsdmpo) {
  var mqdmpo = exports._newMQDMPOffi();
  mqdmpo.Options = u.flagsToNumber('MQDMPO',jsdmpo.Options);
  return mqdmpo;
};

exports._copyPDtoC = function(jspd) {
  var mqpd = exports._newMQPDffi();
  mqpd.Options = u.flagsToNumber('MQPD_OPTIONS',jspd.Options);
  mqpd.Support = jspd.Support;
  mqpd.Context = jspd.Context;
  mqpd.CopyOptions = u.flagsToNumber('MQCOPY',jspd.CopyOptions);
  return mqpd;
};
