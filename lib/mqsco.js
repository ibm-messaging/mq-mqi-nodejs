...
var _MQSCOffi_t = StructType({
  ...
  KeyRepoPasswordPtr    : MQT.PTR,
  KeyRepoPasswordOffset : MQT.LONG,
  KeyRepoPasswordLength : MQT.LONG
});
...
exports._newMQSCOffi = function() {
  ...
  sco.KeyRepoPasswordPtr = ref.NULL_POINTER;
  sco.KeyRepoPasswordOffset = 0;
  sco.KeyRepoPasswordLength = 0;
  return sco;
};
...
exports._copySCOtoC = function(jssco) {
  ...
  if (jssco.KeyRepoPassword != null) {
    mqsco.KeyRepoPasswordPtr = ref.allocCString(jssco.KeyRepoPassword);
    mqsco.KeyRepoPasswordOffset = 0;
    mqsco.KeyRepoPasswordLength = jssco.KeyRepoPassword.length;
    if (mqsco.Version < 6) {
      mqsco.Version = 6;
    }
  }
...
/*
 *  Make sure any allocated memory is freed up if set during the initial copyTo
*/
