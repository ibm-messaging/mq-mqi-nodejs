...
exports._copyGMOtoC = function(jsgmo) {
  ...
  var i;
  mqgmo.Options          = u.flagsToNumber('MQGMO',jsgmo.Options);
  ...
  mqgmo.MatchOptions     = u.flagsToNumber('MQMO',jsgmo.MatchOptions);
...
exports._copyGMOfromC = function(mqgmo, jsgmo) {
  ...
  jsgmo.Options          = u.flagsFromNumber('MQGMO',jsgmo.Options,mqgmo.Options);
