...
var gmoOffsets = {};
var gmo_default = Buffer.alloc(MQC.MQGMO_LENGTH_4);
...
function createDefaultGMOBuf() {
  ...
  if (o.offset != gmo.length) {
    console.log("Bad length for MQGMO - check initial structure fields");
  }
  else {
    // console.log("GMO Offsets map = %o\nFinal offset=%d. Should be %d.", gmoOffsets, o.offset, MQC.MQGMO_LENGTH_4);
  }
  return gmo;
}

function _newBuf() {
  var b = Buffer.alloc(MQC.MQGMO_LENGTH_4);
  gmo_default.copy(b);
  return b;
}
