 ...
 /* Source File:                                                 */
 /* @(#) MQMBID sn=p934-L230927 su=_4-aYmF0ZEe6zC4r8n5F4rg       */
 ...
 #define MQWQR_VERSION_4                4
 #define MQWQR_CURRENT_VERSION          4

 /* Structure Length */
 #define MQWQR_LENGTH_1                 200
 #define MQWQR_LENGTH_2                 208
 #define MQWQR_LENGTH_3                 212
 #define MQWQR_LENGTH_4                 216
 #define MQWQR_CURRENT_LENGTH           216
 ...
 /****************************************************************/
 /* Values Related to MQWQR4 Structure                           */
 /****************************************************************/

 /* Structure Length */
 #define MQWQR4_LENGTH_1                200
 #define MQWQR4_LENGTH_2                208
 #define MQWQR4_LENGTH_3                212
 #define MQWQR4_LENGTH_4                216
 #define MQWQR4_CURRENT_LENGTH          216
...
/* Initial values for MQCD when passed on MQCONNX function */
 ...
 /****************************************************************/
 /* MQWQR4 Structure -- Version-4 CLWL Exit Queue         Record */
 /****************************************************************/


 typedef struct tagMQWQR4 MQWQR4;
 typedef MQWQR4  MQPOINTER PMQWQR4;
 typedef PMQWQR4 MQPOINTER PPMQWQR4;
 ...
 #define MQWQR4_DEFAULT {MQWQR_STRUC_ID_ARRAY},\
                        MQWQR_VERSION_4,\
                        MQWQR_LENGTH_4,\
                        0,\
                        {""},\
