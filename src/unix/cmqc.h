 ...
 #if defined(__powerpc64__) || defined(__x86_64__) || defined(__ia64__) || defined(__s390x__) || defined(__aarch64__)
  #define MQ_64_BIT
 #endif
 ...
 /* Structure Identifier */
 #define MQBNO_STRUC_ID                 "BNO "

 /* Structure Identifier (array form) */
 #define MQBNO_STRUC_ID_ARRAY           'B','N','O',' '

 /* Structure Version Number */
 #define MQBNO_VERSION_1                1
 #define MQBNO_CURRENT_VERSION          1

 /* Structure Length */
 #define MQBNO_LENGTH_1                 20
 #define MQBNO_CURRENT_LENGTH           20

 /* MQ Balancing Options */
 #define MQBNO_OPTIONS_NONE             0x00000000
 #define MQBNO_OPTIONS_IGNORE_TRANS     0x00000001

 /* MQ Balancing Application Type */
 #define MQBNO_BALTYPE_SIMPLE           0x00000000
 #define MQBNO_BALTYPE_REQREP           0x00000001
 #define MQBNO_BALTYPE_RA_MANAGED       0x00010000

 /* MQ Balancing Timeout */
 #define MQBNO_TIMEOUT_AS_DEFAULT       (-1)
 #define MQBNO_TIMEOUT_IMMEDIATE        0
 #define MQBNO_TIMEOUT_NEVER            (-2)
 ...
 #define MQCNO_VERSION_7                7
 #define MQCNO_VERSION_8                8
 #define MQCNO_CURRENT_VERSION          8
...
#endif
#if defined(MQ_64_BIT)
 #define MQCNO_LENGTH_7                 256
#else
 #define MQCNO_LENGTH_7                 240
#endif
#if defined(MQ_64_BIT)
 #define MQCNO_LENGTH_8                 272
#else
 #define MQCNO_LENGTH_8                 252
#endif
#if defined(MQ_64_BIT)
 #define MQCNO_CURRENT_LENGTH           272
#else
 #define MQCNO_CURRENT_LENGTH           252
#endif
 ...
 #define MQCNO_GENERATE_CONN_TAG        0x00200000
 ...
 #define MQFB_DATA_LENGTH_TOO_SHORT     299
 ...
 #define MQ_SSL_ENCRYP_KEY_REPO_PWD_LEN 1536
 ...
 #define MQ_SSL_KEY_REPO_PWD_LEN        1024
 ...
 #define MQ_TEMPORARY_Q_PREFIX_LENGTH   32
 ...
 #define MQST_BEST_EFFORT               0
 #define MQST_MUST_DUP                  1
 ...
 #define MQCMDL_LEVEL_912               912
 #define MQCMDL_LEVEL_913               913
 #define MQCMDL_LEVEL_914               914
 #define MQCMDL_LEVEL_915               915
 #define MQCMDL_LEVEL_920               920
 #define MQCMDL_LEVEL_921               921
 #define MQCMDL_LEVEL_922               922
 #define MQCMDL_LEVEL_923               923
 ...
 #define MQCA_SSL_KEY_REPO_PASSWORD     2055
 ...
 #define MQCA_STREAM_QUEUE_NAME         2138
 ...
 #define MQIA_MAX_Q_FILE_SIZE           274
 ...
 #define MQIA_STREAM_QUEUE_QOS          275
 ...
 /****************************************************************/
 /* MQBNO Structure - MQ Balancing Options                       */
 /****************************************************************/


 typedef struct tagMQBNO MQBNO;
 typedef MQBNO  MQPOINTER PMQBNO;
 typedef PMQBNO MQPOINTER PPMQBNO;

 struct tagMQBNO {
   MQCHAR4  StrucId;   /* Structure identifier */
   MQLONG   Version;   /* Structure version number */
   MQLONG   ApplType;  /* Application Balancing Type */
   MQLONG   Timeout;   /* Timeout value in seconds */
   MQLONG   Options;   /* Additional Balancing Options */
 };

 #define MQBNO_DEFAULT {MQBNO_STRUC_ID_ARRAY},\
                       MQBNO_VERSION_1,\
