...
declare module "ibmmq" {
  ...
  class MQMD {
    ...
    Format: Buffer | integer[] | object | string;
    Priority: number;
    Persistence: number;
    MsgId: Buffer | integer[] | object | string;
    CorrelId: Buffer | integer[] | object | string;
    BackoutCount: number;
    ReplyToQ: string;
    ReplyToQMgr: string;
    UserIdentifier: string;
    AccountingToken: Buffer | integer[] | object | string;
    ...
    GroupId: Buffer | integer[] | object | string;
    MsgSeqNumber: number;
    Offset: number;
    MsgFlags: number;
